...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AircraftRegistration.status_code'
        db.alter_column('aircraft_aircraftregistration', 'status_code', self.gf('django.db.models.fields.CharField')(max_length=2, null=True))


    def backwards(self, orm):
        
        # Changing field 'AircraftRegistration.status_code'
        db.alter_column('aircraft_aircraftregistration', 'status_code', self.gf('django.db.models.fields.CharField')(max_length=1, null=True))
