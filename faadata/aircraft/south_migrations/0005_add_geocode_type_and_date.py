...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AircraftRegistration.geocode_type'
        db.add_column('aircraft_aircraftregistration', 'geocode_type', self.gf('django.db.models.fields.CharField')(max_length=2, null=True, blank=True), keep_default=False)

        # Adding field 'AircraftRegistration.geocode_date'
        db.add_column('aircraft_aircraftregistration', 'geocode_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AircraftRegistration.geocode_type'
        db.delete_column('aircraft_aircraftregistration', 'geocode_type')

        # Deleting field 'AircraftRegistration.geocode_date'
        db.delete_column('aircraft_aircraftregistration', 'geocode_date')
