...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AircraftRegistration.unique_id'
        db.add_column('aircraft_aircraftregistration', 'unique_id',
                      self.gf('django.db.models.fields.CharField')(max_length=8, null=True, blank=True),
                      keep_default=False)

        # Adding field 'AircraftRegistration.kit_manufacturer'
        db.add_column('aircraft_aircraftregistration', 'kit_manufacturer',
                      self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True),
                      keep_default=False)

        # Adding field 'AircraftRegistration.kit_model'
        db.add_column('aircraft_aircraftregistration', 'kit_model',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)

        # Adding field 'AircraftRegistration.mode_s_code_hex'
        db.add_column('aircraft_aircraftregistration', 'mode_s_code_hex',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AircraftRegistration.unique_id'
        db.delete_column('aircraft_aircraftregistration', 'unique_id')

        # Deleting field 'AircraftRegistration.kit_manufacturer'
        db.delete_column('aircraft_aircraftregistration', 'kit_manufacturer')

        # Deleting field 'AircraftRegistration.kit_model'
        db.delete_column('aircraft_aircraftregistration', 'kit_model')

        # Deleting field 'AircraftRegistration.mode_s_code_hex'
        db.delete_column('aircraft_aircraftregistration', 'mode_s_code_hex')
    ...
    models = {
        ...
        'aircraft.aircraftregistration': {
            ...
            'geocode_date': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'geocode_type': ('django.db.models.fields.CharField', [], {'max_length': '2', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'kit_manufacturer': ('django.db.models.fields.CharField', [], {'max_length': '30', 'null': 'True', 'blank': 'True'}),
            'kit_model': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'}),
            ...
            'mode_s_code_hex': ('django.db.models.fields.CharField', [], {'max_length': '10', 'null': 'True', 'blank': 'True'}),
            ...
            'unique_id': ('django.db.models.fields.CharField', [], {'max_length': '8', 'null': 'True', 'blank': 'True'}),
