...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Remark.element_name'
        db.alter_column('airports_remark', 'element_name', self.gf('django.db.models.fields.CharField')(max_length=13))

    def backwards(self, orm):

        # Changing field 'Remark.element_name'
        db.alter_column('airports_remark', 'element_name', self.gf('django.db.models.fields.CharField')(max_length=11))
    ...
    models = {
        ...
        'airports.remark': {
            ...
            'element_name': ('django.db.models.fields.CharField', [], {'max_length': '13'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        'airports.runway': {
