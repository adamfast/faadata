...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Airport.facility_type'
        db.add_column('airports_airport', 'facility_type', self.gf('django.db.models.fields.CharField')(default='', max_length=16), keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Airport.facility_type'
        db.delete_column('airports_airport', 'facility_type')
