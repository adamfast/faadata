...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Airport.facility_name'
        db.alter_column('airports_airport', 'facility_name', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'Airport.elevation_msl'
        db.alter_column('airports_airport', 'elevation_msl', self.gf('django.db.models.fields.DecimalField')(max_digits=7, decimal_places=1))


    def backwards(self, orm):
        
        # Changing field 'Airport.facility_name'
        db.alter_column('airports_airport', 'facility_name', self.gf('django.db.models.fields.CharField')(max_length=42))

        # Changing field 'Airport.elevation_msl'
        db.alter_column('airports_airport', 'elevation_msl', self.gf('django.db.models.fields.IntegerField')())
